...
**Scenario:**
The business needs a defensible, data-driven approach to **exploratory data analysis deep dive**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Telco Customer Churn**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Exploratory Data Analysis Deep Dive**.
...
**Description:** A dataset containing 7,043 customer records from a telecom company with 21 features including demographics, account info, services, and churn label.
