# 📤 SUBMISSION GUIDELINES — Task 01: Exploratory Data Analysis Deep Dive
...
```
Task_01_Exploratory_Data_Analysis_Deep_Dive/
...
```markdown
# Task 01 — Exploratory Data Analysis Deep Dive — Report
...
| Mentor review request | Open a GitHub Issue titled `Review: Task 01` |
