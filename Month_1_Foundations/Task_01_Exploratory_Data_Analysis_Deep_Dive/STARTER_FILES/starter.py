...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 01."""
    raise NotImplementedError("Fill me in — Task 01: Exploratory Data Analysis Deep Dive")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 01: Exploratory Data Analysis Deep Dive")
