...
| Key Skills | Hypothesis testing (t-test, chi-square, ANOVA, Mann-Whitney), confidence intervals, p-value interpretation, effect sizes, multiple comparison correction |

---

## 🎯 Learning Objectives
After completing this task, you should be able to:
1. Understand the core principles of statistical analysis and hypothesis testing
...
## 🏢 Business Scenario
A health insurance company needs to know if smokers truly cost more, if BMI affects charges, if region matters — to set fair premiums. Wrong stats = regulatory fines + discrimination claims.
...
### 1. Data Processing
- [ ] Load the dataset: **Medical Cost Personal (Kaggle)**
- [ ] Perform appropriate data cleaning and preprocessing
- [ ] Document all transformations and justify them

### 2. Implementation
- [ ] Implement the core solution using statistical test selection helper, effect size calculator, confidence interval functions
- [ ] Follow best practices for Statistical Analysis and Hypothesis Testing
...
## 🧭 Dataset
**Name:** Medical Cost Personal (Kaggle)
