...
**Scenario:**
The business needs a defensible, data-driven approach to **statistical analysis & hypothesis testing**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Marketing A/B Test**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Statistical Analysis & Hypothesis Testing**.
...
**Description:** A/B test data containing user-level conversion outcomes from a marketing campaign across control and treatment groups.
