...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 04."""
    raise NotImplementedError("Fill me in — Task 04: Statistical Analysis & Hypothesis Testing")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 04: Statistical Analysis & Hypothesis Testing")
