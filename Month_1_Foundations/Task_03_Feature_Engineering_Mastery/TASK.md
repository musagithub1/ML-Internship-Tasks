...
**Scenario:**
The business needs a defensible, data-driven approach to **feature engineering mastery**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **House Prices - Advanced Regression**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Feature Engineering Mastery**.
...
**Description:** Ames Housing dataset with 79 explanatory variables describing residential homes in Ames, Iowa — classic feature engineering playground.
**Source:** [https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques](https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques)
