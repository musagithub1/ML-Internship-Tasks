...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 03."""
    raise NotImplementedError("Fill me in — Task 03: Feature Engineering Mastery")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 03: Feature Engineering Mastery")
