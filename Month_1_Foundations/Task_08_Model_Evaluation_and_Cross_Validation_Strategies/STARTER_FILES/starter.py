...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 08."""
    raise NotImplementedError("Fill me in — Task 08: Model Evaluation & Cross-Validation Strategies")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 08: Model Evaluation & Cross-Validation Strategies")
