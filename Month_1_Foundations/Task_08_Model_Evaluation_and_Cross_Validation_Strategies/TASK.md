...
**Scenario:**
The business needs a defensible, data-driven approach to **model evaluation & cross-validation strategies**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Credit Card Fraud Detection**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Model Evaluation & Cross-Validation Strategies**.
...
**Description:** 284,807 transactions with 492 frauds — highly imbalanced binary classification benchmark.
