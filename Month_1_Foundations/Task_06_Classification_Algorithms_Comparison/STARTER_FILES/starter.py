...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 06."""
    raise NotImplementedError("Fill me in — Task 06: Classification Algorithms Comparison")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 06: Classification Algorithms Comparison")
