...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 05."""
    raise NotImplementedError("Fill me in — Task 05: Regression Modeling: From Scratch to Production")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 05: Regression Modeling: From Scratch to Production")
