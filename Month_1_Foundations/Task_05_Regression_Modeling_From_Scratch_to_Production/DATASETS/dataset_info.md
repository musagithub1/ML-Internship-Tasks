# 📊 Dataset — Task 05: Regression Modeling: From Scratch to Production
...
**Description:**
1,338 rows of medical insurance charges with age, sex, BMI, children, smoker status, and region.
