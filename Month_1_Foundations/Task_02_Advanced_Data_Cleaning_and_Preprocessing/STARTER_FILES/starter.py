...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 02."""
    raise NotImplementedError("Fill me in — Task 02: Advanced Data Cleaning & Preprocessing")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 02: Advanced Data Cleaning & Preprocessing")
