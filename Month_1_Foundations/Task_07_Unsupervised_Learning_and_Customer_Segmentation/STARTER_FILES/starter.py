...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 07."""
    raise NotImplementedError("Fill me in — Task 07: Unsupervised Learning & Customer Segmentation")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 07: Unsupervised Learning & Customer Segmentation")
