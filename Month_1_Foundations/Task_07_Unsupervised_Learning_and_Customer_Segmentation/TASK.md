...
**Scenario:**
The business needs a defensible, data-driven approach to **unsupervised learning & customer segmentation**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Mall Customer Segmentation**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Unsupervised Learning & Customer Segmentation**.
...
**Description:** 200 mall customers with annual income and spending score — classic segmentation dataset.
