...
**Scenario:**
The business needs a defensible, data-driven approach to **mlops: experiment tracking with mlflow**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Bike Sharing Demand**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **MLOps: Experiment Tracking with MLflow**.
...
**Description:** Hourly bike rental counts with weather and seasonal information — perfect for iterative experiment tracking.
**Source:** [https://www.kaggle.com/competitions/bike-sharing-demand](https://www.kaggle.com/competitions/bike-sharing-demand)
