# 📤 SUBMISSION GUIDELINES — Task 14: NLP Foundations: Text Classification
...
```
Task_14_NLP_Foundations_Text_Classification/
...
```markdown
# Task 14 — NLP Foundations: Text Classification — Report
...
| Mentor review request | Open a GitHub Issue titled `Review: Task 14` |
