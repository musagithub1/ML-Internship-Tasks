...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 14."""
    raise NotImplementedError("Fill me in — Task 14: NLP Foundations: Text Classification")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 14: NLP Foundations: Text Classification")
