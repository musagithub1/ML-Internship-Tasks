...
**Scenario:**
The business needs a defensible, data-driven approach to **ensemble methods: bagging, boosting & stacking**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Otto Group Product Classification**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Ensemble Methods: Bagging, Boosting & Stacking**.
...
**Description:** Multi-class product classification with 93 obfuscated numeric features over 9 categories.
