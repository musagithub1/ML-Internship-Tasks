...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 11."""
    raise NotImplementedError("Fill me in — Task 11: Ensemble Methods: Bagging, Boosting & Stacking")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 11: Ensemble Methods: Bagging, Boosting & Stacking")
