...
| Prerequisites | Tasks 05, 08 |
| Key Skills | Stationarity (ADF test), decomposition, ARIMA/SARIMA, Prophet, ML approach (lag features + XGBoost), walk-forward validation, seasonality handling, forecast horizons |
...
## 🏢 Business Scenario
Grocery chain with 54 stores needs 16-day sales forecasts for inventory ordering. Overforecast by 10% = $45K/week wasted in spoiled goods. Underforecast by 10% = $60K/week in lost sales from empty shelves.
...
### 1. Data Processing
- [ ] Load the dataset: **Store Sales - Time Series Forecasting (Kaggle)**
- [ ] Perform appropriate data cleaning and preprocessing
- [ ] Document all transformations and justify them

### 2. Implementation
- [ ] Implement the core solution using time series specific split (TimeSeriesSplit), stationarity testing, decomposition plots, ARIMA fitting scaffold, Prophet setup, lag feature engineering
...
## 🧭 Dataset
**Name:** Store Sales - Time Series Forecasting (Kaggle)
