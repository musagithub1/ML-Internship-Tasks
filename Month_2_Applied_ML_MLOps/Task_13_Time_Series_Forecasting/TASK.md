...
**Scenario:**
The business needs a defensible, data-driven approach to **time series forecasting**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Rossmann Store Sales**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Time Series Forecasting**.
...
**Description:** Historical sales data for 1,115 Rossmann stores across Europe with promotions, holidays, and competition info.
**Source:** [https://www.kaggle.com/competitions/rossmann-store-sales](https://www.kaggle.com/competitions/rossmann-store-sales)
