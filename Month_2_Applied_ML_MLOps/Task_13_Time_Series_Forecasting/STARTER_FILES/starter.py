...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 13."""
    raise NotImplementedError("Fill me in — Task 13: Time Series Forecasting")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 13: Time Series Forecasting")
