...
**Scenario:**
The business needs a defensible, data-driven approach to **hyperparameter tuning & automl**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Wine Quality**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Hyperparameter Tuning & AutoML**.
...
**Name:** Wine Quality
**Description:** 1,599 red wine samples with 11 physicochemical features predicting quality (0-10).
