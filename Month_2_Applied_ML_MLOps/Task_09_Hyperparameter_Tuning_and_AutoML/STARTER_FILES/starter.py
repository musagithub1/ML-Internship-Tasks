...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 09."""
    raise NotImplementedError("Fill me in — Task 09: Hyperparameter Tuning & AutoML")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 09: Hyperparameter Tuning & AutoML")
