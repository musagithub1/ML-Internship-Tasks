# 📤 SUBMISSION GUIDELINES — Task 10: Pipeline Engineering with Scikit-Learn
...
```markdown
# Task 10 — Pipeline Engineering with Scikit-Learn — Report
...
| Mentor review request | Open a GitHub Issue titled `Review: Task 10` |
