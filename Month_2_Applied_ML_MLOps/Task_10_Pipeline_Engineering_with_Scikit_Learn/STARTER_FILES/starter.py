...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 10."""
    raise NotImplementedError("Fill me in — Task 10: Pipeline Engineering with Scikit-Learn")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 10: Pipeline Engineering with Scikit-Learn")
