...
**Scenario:**
The business needs a defensible, data-driven approach to **model interpretation with shap & lime**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Adult Census Income**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Model Interpretation with SHAP & LIME**.
...
**Description:** 48,842 census records predicting whether income exceeds $50K/year — used for fairness and interpretability studies.
**Source:** [https://www.kaggle.com/datasets/uciml/adult-census-income](https://www.kaggle.com/datasets/uciml/adult-census-income)
