...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 12."""
    raise NotImplementedError("Fill me in — Task 12: Model Interpretation with SHAP & LIME")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 12: Model Interpretation with SHAP & LIME")
