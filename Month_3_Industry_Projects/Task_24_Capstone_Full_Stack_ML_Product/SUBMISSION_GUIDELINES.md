# 📤 SUBMISSION GUIDELINES — Task 24: Capstone: Full-Stack ML Product
...
```
Task_24_Capstone_Full_Stack_ML_Product/
...
```markdown
# Task 24 — Capstone: Full-Stack ML Product — Report
...
| Mentor review request | Open a GitHub Issue titled `Review: Task 24` |
