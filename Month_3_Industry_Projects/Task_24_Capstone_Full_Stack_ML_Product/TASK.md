...
**Scenario:**
The business needs a defensible, data-driven approach to **capstone: full-stack ml product**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Student-selected**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Capstone: Full-Stack ML Product**.
...
**Name:** Student-selected
**Description:** Student chooses a domain dataset (healthcare, finance, climate, retail) and justifies the choice in the project brief.
