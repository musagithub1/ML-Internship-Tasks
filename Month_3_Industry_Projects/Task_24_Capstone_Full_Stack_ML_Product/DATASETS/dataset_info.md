# 📊 Dataset — Task 24: Capstone: Full-Stack ML Product
...
**Description:**
Student chooses a domain dataset (healthcare, finance, climate, retail) and justifies the choice in the project brief.
