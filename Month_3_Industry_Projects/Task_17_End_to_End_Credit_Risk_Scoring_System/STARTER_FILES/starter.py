...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 17."""
    raise NotImplementedError("Fill me in — Task 17: End-to-End Credit Risk Scoring System")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 17: End-to-End Credit Risk Scoring System")
