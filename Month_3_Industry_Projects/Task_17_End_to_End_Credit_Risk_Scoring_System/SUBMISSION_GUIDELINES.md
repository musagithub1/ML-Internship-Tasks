# 📤 SUBMISSION GUIDELINES — Task 17: End-to-End Credit Risk Scoring System
...
```
Task_17_End_to_End_Credit_Risk_Scoring_System/
...
```markdown
# Task 17 — End-to-End Credit Risk Scoring System — Report
...
| Mentor review request | Open a GitHub Issue titled `Review: Task 17` |
