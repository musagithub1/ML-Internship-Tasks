...
**Scenario:**
The business needs a defensible, data-driven approach to **end-to-end credit risk scoring system**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Home Credit Default Risk**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **End-to-End Credit Risk Scoring System**.
...
**Description:** Anonymized application, bureau, and behavioral data for predicting loan default — industry-grade complexity.
