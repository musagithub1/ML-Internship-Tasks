...
**Scenario:**
The business needs a defensible, data-driven approach to **computer vision: image classification project**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **Intel Image Classification**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Computer Vision: Image Classification Project**.
...
**Description:** 25,000 natural scene images across 6 categories (buildings, forest, glacier, mountain, sea, street).
**Source:** [https://www.kaggle.com/datasets/puneet6060/intel-image-classification](https://www.kaggle.com/datasets/puneet6060/intel-image-classification)
