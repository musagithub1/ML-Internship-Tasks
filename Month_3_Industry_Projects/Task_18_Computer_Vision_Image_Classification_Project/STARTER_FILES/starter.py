...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 18."""
    raise NotImplementedError("Fill me in — Task 18: Computer Vision: Image Classification Project")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 18: Computer Vision: Image Classification Project")
