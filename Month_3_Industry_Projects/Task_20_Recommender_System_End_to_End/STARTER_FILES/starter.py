...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 20."""
    raise NotImplementedError("Fill me in — Task 20: Recommender System End-to-End")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 20: Recommender System End-to-End")
