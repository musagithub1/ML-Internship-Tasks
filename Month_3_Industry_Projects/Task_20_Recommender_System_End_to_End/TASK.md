...
**Scenario:**
The business needs a defensible, data-driven approach to **recommender system end-to-end**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **MovieLens 100K**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Recommender System End-to-End**.
...
**Name:** MovieLens 100K
**Description:** 100,000 movie ratings from 943 users across 1,682 movies — classic recsys benchmark.
**Source:** [https://www.kaggle.com/datasets/prajitdatta/movielens-100k-dataset](https://www.kaggle.com/datasets/prajitdatta/movielens-100k-dataset)
