# 📤 SUBMISSION GUIDELINES — Task 19: NLP Project: Transformer Fine-Tuning
...
```
Task_19_NLP_Project_Transformer_Fine_Tuning/
...
```markdown
# Task 19 — NLP Project: Transformer Fine-Tuning — Report
...
| Mentor review request | Open a GitHub Issue titled `Review: Task 19` |
