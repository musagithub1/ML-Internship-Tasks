...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 19."""
    raise NotImplementedError("Fill me in — Task 19: NLP Project: Transformer Fine-Tuning")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 19: NLP Project: Transformer Fine-Tuning")
