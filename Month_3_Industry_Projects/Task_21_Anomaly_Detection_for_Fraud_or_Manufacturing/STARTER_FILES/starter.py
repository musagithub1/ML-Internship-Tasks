...
def train_model(X: pd.DataFrame, y: pd.Series):
    """TODO: implement training logic for Task 21."""
    raise NotImplementedError("Fill me in — Task 21: Anomaly Detection for Fraud / Manufacturing")
...
# ----------------------------- Main -----------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Task 21: Anomaly Detection for Fraud / Manufacturing")
