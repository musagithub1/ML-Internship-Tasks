# 📋 TASK 21 — Anomaly Detection for Fraud / Manufacturing
...
**Scenario:**
The business needs a defensible, data-driven approach to **anomaly detection for fraud / manufacturing**. Decisions made downstream (pricing, targeting, risk approval, hiring) will rely on the quality of your work. A wrong call costs the company money, reputation, or compliance penalties.
...
### 2. Data
- [ ] Use the recommended dataset: **IEEE-CIS Fraud Detection**.
- [ ] Document its schema, size, and source.
- [ ] Identify potential data quality issues *before* modeling.

### 3. Methodology
- [ ] Implement the core technique(s) required for **Anomaly Detection for Fraud / Manufacturing**.
...
**Description:** Real-world e-commerce transaction data from Vesta — massive scale and class imbalance.
