# 📤 SUBMISSION GUIDELINES — Task 21: Anomaly Detection for Fraud / Manufacturing
...
```
Task_21_Anomaly_Detection_for_Fraud_or_Manufacturing/
...
```markdown
# Task 21 — Anomaly Detection for Fraud / Manufacturing — Report
...
| Mentor review request | Open a GitHub Issue titled `Review: Task 21` |
